...
class Employee:
    ...
    _total_pay: The total amount of pay received by this employee.
    """
    id_: int
    name: str
    _total_pay: float
    ...
    def total_pay(self) -> float:
        ...
        300.0
        """
        return self.get_total_pay()

    def get_total_pay(self) -> float:
        """
        Returns the _total_pay that this employee has received.
        """
        return self._total_pay

    def add_total_pay(self, value: int) -> None:
        """
        Adds the parameter value to the employee's _total_pay.
        """
        self._total_pay += value
