...
def test_contains() -> None:
    """Test LinkedList.__contains__ for a LinkedList with 2 nodes."""
    lst = LinkedList()
    lst.append(1)
    lst.append(2)
    assert lst.__contains__(1) and lst.__contains__(2)


def test_contains_bug() -> None:
    """Test LinkedList.__contains__ for a bug."""
    lst = LinkedList()
    assert lst.__contains__(1) == False
